		...
		<table class="table">
			<thead>
				<tr>
					...
					<th scope="col">PremiumAmount</th>
					<th scope="col">HolderEmail</th>

					<th scope="col">HolderGender</th>
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="editCustomer.jsp?policyId=<%=c.getPolicyId() %>" class="btn btn-primary">Edit</a>
						<a href="delete?policyId=<%=c.getPolicyId() %>" class="btn btn-danger ms=1" >Delete</a></td>
				</tr>
				<tr>
